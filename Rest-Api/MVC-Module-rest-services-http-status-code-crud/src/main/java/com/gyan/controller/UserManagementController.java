...
public class UserManagementController {
	...
	public ResponseEntity<UserManagementResponse> createUser(@RequestBody UserManagementRequest userManagementRequest ) {
		UserManagementResponse data=userManagementService.createUser(userManagementRequest);
		if(data!=null) {
			System.out.println(userManagementRequest);
			//return new ResponseEntity<UserManagementResponse>(data, HttpStatusCode.valueOf(201)); OR
			//return ResponseEntity.status(HttpStatus.CREATED).body(data); OR
			return ResponseEntity.status(200).body(data);
		}else {
			//return new ResponseEntity<UserManagementResponse>(data, HttpStatusCode.valueOf(200)); OR
			//return ResponseEntity.ok().body(data); OR
	...
	public ResponseEntity<List<UserManagementResponse>> loadAllUser(){
	...
	public ResponseEntity<UserManagementResponse> loadUserDetailsBasedOnEmailId(@PathVariable("emailId") String emailId) {
